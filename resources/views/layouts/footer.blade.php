            ...
            <div class="col-lg-3 col-md-6">
                <div class="footer-item">
                    ...
                    <div class="d-flex flex-column align-items-start">
                        <a class="text-body mb-3" href=""><i class="fa fa-check text-primary me-2"></i>Jerry</a>
                        <a class="text-body mb-3" href=""><i class="fa fa-check text-primary me-2"></i>Harrison</a>
                        <a class="text-body mb-3" href=""><i class="fa fa-check text-primary me-2"></i>Simon</a>
